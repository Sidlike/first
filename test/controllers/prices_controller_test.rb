...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { price: @price.price, pricenn: @price.pricenn, title: @price.title } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { price: @price.price, pricenn: @price.pricenn, title: @price.title } }
